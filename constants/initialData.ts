...
const genPlayers: Player[] = [
  createPlayer("기인", "Kiin", "TOP", "S", 2026, "GEN"),
  createPlayer("김건부", "Canyon", "JGL", "S+", 2026, "GEN"),
  createPlayer("정지훈", "Chovy", "MID", "S+", 2028, "GEN"),
  createPlayer("박재혁", "Ruler", "ADC", "S", 2028, "GEN"),
  createPlayer("두로", "Duro", "SPT", "B+", 2027, "GEN"),
];
initialPlayers.push(...genPlayers);

// 2. HLE (한화생명e스포츠)
const hlePlayers: Player[] = [
  createPlayer("최우제", "Zeus", "TOP", "S+", 2026, "HLE"),
  createPlayer("서진혁", "Kanavi", "JGL", "S", 2026, "HLE"),
  createPlayer("김건우", "Zeka", "MID", "S", 2027, "HLE"),
  createPlayer("이민형", "Gumayusi", "ADC", "S", 2027, "HLE"),
  createPlayer("유환중", "Delight", "SPT", "A+", 2026, "HLE"),
];
initialPlayers.push(...hlePlayers);

// 3. T1
const t1Players: Player[] = [
  createPlayer("최현준", "Doran", "TOP", "A+", 2026, "T1"),
  createPlayer("문현준", "Oner", "JGL", "S", 2026, "T1"),
  createPlayer("이상혁", "Faker", "MID", "S", 2029, "T1", "1군", 28), // 운영 S+ 특별 처리
  createPlayer("김수환", "Peyz", "ADC", "S", 2028, "T1"),
  createPlayer("류민석", "Keria", "SPT", "S+", 2026, "T1"),
];
...
const ktPlayers: Player[] = [
  createPlayer("퍼펙트", "PerfecT", "TOP", "B+", 2026, "KT"),
  createPlayer("문우찬", "Cuzz", "JGL", "A", 2027, "KT"),
  createPlayer("곽보성", "Bdd", "MID", "S-", 2026, "KT"),
  createPlayer("하성민", "Aiming", "ADC", "A+", 2026, "KT"),
  createPlayer("폴루", "Pollu", "SPT", "C+", 2026, "KT", "1군"),
  createPlayer("장용준", "Ghost", "SPT", "B-", 2026, "KT", "2군"),
];
initialPlayers.push(...ktPlayers);

// 5. Dplus KIA (DK)
const dkPlayers: Player[] = [
  createPlayer("시우", "Siwoo", "TOP", "B+", 2027, "DK"),
  createPlayer("이용우", "Lucid", "JGL", "A-", 2026, "DK"),
  createPlayer("허수", "ShowMaker", "MID", "S-", 2026, "DK"),
  createPlayer("스매시", "Smash", "ADC", "B", 2027, "DK"),
  createPlayer("커리어", "Career", "SPT", "C+", 2026, "DK"),
];
initialPlayers.push(...dkPlayers);

// 6. 농심 레드포스 (NS)
const nsPlayers: Player[] = [
  createPlayer("황성훈", "Kingen", "TOP", "A", 2026, "NS"),
  createPlayer("스폰지", "Sponge", "JGL", "B-", 2026, "NS"),
  createPlayer("이예찬", "Scout", "MID", "S-", 2026, "NS", "1군"),
  createPlayer("칼릭스", "Calix", "MID", "C+", 2027, "NS", "2군"),
  createPlayer("태윤", "Taeyoon", "ADC", "B-", 2026, "NS"),
  createPlayer("손시우", "Lehends", "SPT", "A", 2026, "NS"),
];
initialPlayers.push(...nsPlayers);

// 7. BNK 피어엑스 (BFX)
const bfxPlayers: Player[] = [
  createPlayer("클리어", "Clear", "TOP", "B", 2026, "BFX"),
  createPlayer("랩터", "Raptor", "JGL", "B-", 2026, "BFX"),
  createPlayer("빅라", "VicLa", "MID", "B", 2026, "BFX", "1군"),
  createPlayer("데이스타", "Daystar", "MID", "C+", 2026, "BFX", "2군"),
  createPlayer("디아블", "Diable", "ADC", "B-", 2026, "BFX"),
  createPlayer("켈린", "Kellin", "SPT", "A-", 2026, "BFX"),
];
initialPlayers.push(...bfxPlayers);

// 8. OK저축은행 브리온 (BRO)
const broPlayers: Player[] = [
  createPlayer("캐스팅", "Casting", "TOP", "C", 2027, "BRO"),
  createPlayer("기디언", "GIDEON", "JGL", "B", 2026, "BRO"),
  createPlayer("피셔", "Fisher", "MID", "B-", 2026, "BRO"),
  createPlayer("성승헌", "Teddy", "ADC", "A-", 2026, "BRO"),
  createPlayer("남궁", "Namgung", "SPT", "C", 2027, "BRO"),
];
initialPlayers.push(...broPlayers);

// 9. DRX
const drxPlayers: Player[] = [
  createPlayer("리치", "Rich", "TOP", "B-", 2026, "DRX"),
  createPlayer("윌러", "Willer", "JGL", "B+", 2026, "DRX", "1군"),
  createPlayer("빈첸조", "Vincenzo", "JGL", "C", 2026, "DRX", "2군"),
  createPlayer("우칼", "Ucal", "MID", "B+", 2026, "DRX"),
  createPlayer("지우", "Jiwoo", "ADC", "A-", 2027, "DRX"),
  createPlayer("안딜", "Andil", "SPT", "B-", 2026, "DRX"),
];
initialPlayers.push(...drxPlayers);

// 10. DN Freecs (광동) - KDF
const kdfPlayers: Player[] = [
  createPlayer("두두", "DuDu", "TOP", "A-", 2026, "KDF"),
  createPlayer("홍창현", "Pyosik", "JGL", "A", 2026, "KDF"),
  createPlayer("이주현", "Clozer", "MID", "A-", 2026, "KDF"),
  createPlayer("서대길", "deokdam", "ADC", "B+", 2026, "KDF"),
  createPlayer("김시윤", "Life", "SPT", "B+", 2026, "KDF", "1군"),
  createPlayer("피터", "Peter", "SPT", "B-", 2026, "KDF", "2군"),
];
